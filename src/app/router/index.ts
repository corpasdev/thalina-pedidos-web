...
{ path: 'vendedores', name: 'vendedores', component: () => import('@/pages/vendedores/VendedoresPage.vue') },
        ...
        { path: 'borradores', name: 'borradores', component: () => import('@/pages/borradores/BorradoresPage.vue') },
        { path: 'borradores/nuevo', name: 'borrador-nuevo', component: () => import('@/pages/borradores/BorradorFormPage.vue') },
        { path: 'borradores/:id/editar', name: 'borrador-editar', component: () => import('@/pages/borradores/BorradorFormPage.vue'), props: true },
